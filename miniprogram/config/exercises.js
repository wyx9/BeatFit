...
const PRESET_TEMPLATES = [
  ...
  {
    id: 'preset_chest_shape',
    name: '胸部塑形计划',
    preset: true,
    exercises: [
      { name: '平板卧推',         tag: '力量', sets: 3, reps: 10, duration_sec: 30, rest_sec: 60 },
      { name: '上斜哑铃卧推',     tag: '肥大', sets: 3, reps: 12, duration_sec: 30, rest_sec: 60 },
      { name: '哑铃飞鸟',         tag: '塑形', sets: 3, reps: 12, duration_sec: 30, rest_sec: 45 },
      { name: '高位绳索夹胸',     tag: '塑形', sets: 2, reps: 15, duration_sec: 30, rest_sec: 45 }
    ]
  },
  {
    id: 'preset_core_abs',
    ...
    preset: true,
    exercises: [
      { name: '平板支撑',     tag: '耐力', sets: 3, reps: 1,  duration_sec: 45, rest_sec: 30 },
      { name: '卷腹',         tag: '塑形', sets: 3, reps: 20, duration_sec: 30, rest_sec: 30 },
      { name: '悬垂举腿',     tag: '力量', sets: 3, reps: 12, duration_sec: 30, rest_sec: 45 },
      { name: '俄罗斯转体',   tag: '塑形', sets: 3, reps: 20, duration_sec: 30, rest_sec: 30 }
    ]
  }
]
